...
public class SparseDoubleMatrix2D extends DoubleMatrix2D implements Writable {
	...
	*/
    ...
    public void write(DataOutput out) throws IOException {
        ...
        out.writeInt(columnStride);
        out.writeInt(rowZero);
        out.writeInt(columnZero);
        out.writeBoolean(isNoView);
        ((Writable) elements).write(out);
    }
    ...
    public void readFields(DataInput in) throws IOException {
        ...
        columnStride = in.readInt();
        rowZero = in.readInt();
        columnZero = in.readInt();
        isNoView = in.readBoolean();
        ((Writable)elements).readFields(in);
    }
}
